...
func (_mock *OrderRepository) Create(ctx context.Context, order model.Order) (model.Order, error) {
...
func (_c *OrderRepository_Create_Call) RunAndReturn(run func(ctx context.Context, order model.Order) (model.Order, error)) *OrderRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}

// Delete provides a mock function for the type OrderRepository
func (_mock *OrderRepository) Delete(ctx context.Context, uuid string) error {
...
//   - ctx context.Context
//   - uuid string
func (_e *OrderRepository_Expecter) Delete(ctx interface{}, uuid interface{}) *OrderRepository_Delete_Call {
	return &OrderRepository_Delete_Call{Call: _e.mock.On("Delete", ctx, uuid)}
}

func (_c *OrderRepository_Delete_Call) Run(run func(ctx context.Context, uuid string)) *OrderRepository_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *OrderRepository_Delete_Call) RunAndReturn(run func(ctx context.Context, uuid string) error) *OrderRepository_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *OrderRepository) Update(ctx context.Context, order model.Order) (model.Order, error) {
	ret := _mock.Called(ctx, order)
...
func (_c *OrderRepository_Update_Call) Return(order1 model.Order, err error) *OrderRepository_Update_Call {
	_c.Call.Return(order1, err)
	return _c
}

func (_c *OrderRepository_Update_Call) RunAndReturn(run func(ctx context.Context, order model.Order) (model.Order, error)) *OrderRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
