...
func (_mock *PartRepository) List(ctx context.Context, filter model.PartsFilter) ([]model.Part, error) {
...
func (_c *PartRepository_List_Call) RunAndReturn(run func(ctx context.Context, filter model.PartsFilter) ([]model.Part, error)) *PartRepository_List_Call {
	_c.Call.Return(run)
	return _c
}
