...
func (*BadRequestError) createOrderRequestRes() {}
func (*BadRequestError) orderPaymentRes()       {}
...
type CreateOrderRequest struct {
	...
	// Список UUID деталей из заказа.
	PartsUUID []string `json:"parts_uuid"`
}

// GetUUID returns the value of UUID.
func (s *CreateOrderRequest) GetUUID() string {
	return s.UUID
}

// GetPartsUUID returns the value of PartsUUID.
func (s *CreateOrderRequest) GetPartsUUID() []string {
	return s.PartsUUID
}

// SetUUID sets the value of UUID.
func (s *CreateOrderRequest) SetUUID(val string) {
	s.UUID = val
}

// SetPartsUUID sets the value of PartsUUID.
func (s *CreateOrderRequest) SetPartsUUID(val []string) {
	s.PartsUUID = val
}
...
func (*CreateOrderResponse) createOrderRequestRes() {}
...
func (*InternalServerError) createOrderRequestRes() {}
func (*InternalServerError) orderPaymentRes()       {}
...
func (*NotFoundError) getInfoOrderByUUIDRes() {}
func (*NotFoundError) orderPaymentRes()       {}
...
func (*OrderDto) getInfoOrderByUUIDRes() {}
...
func (*PayOrderResponse) orderPaymentRes() {}
